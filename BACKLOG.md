...
As of 2026-07-29, every previously-tracked Milestone is delivered (backend and UI) and closed. The open work in this file is the remaining Confluence-parity section (#352–#360, filed 2026-08-17) plus the one item under "Needs a decision".
...
- ~~**No email delivery or digest (#352, M, P2).**~~ **Implementation complete on `codex/cf6-notification-email`, pending PR integration.** Added localized immediate/digest/off email delivery for mentions and all CF.5 events, recipient preferences with unsubscribe flow, bounded idempotent digest dispatch through `JobDispatcher`, and regression coverage. Plan: `docs/superpowers/plans/2026-08-18-notification-email-channel.md`. **#353 remains gated until #352 is merged.**
