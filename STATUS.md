...
3. **In progress: security/correctness audit findings #145–#148**, filed 2026-07-28. #145 and #146 fixed and merged (PR #149, PR #150). #147 (GrandpaSSOn admin escalation) and #148 (branch protection) are next in the queue, being worked one PR at a time.
